  ...
  return (
    <section id="voces" className="py-8 mb-20 gap-8 flex flex-col items-center">
      ...
      <div className="inline-flex gap-8 h-130 text-white font-courier-prime">
        <div className="translate-y-28 w-80 h-92 pr-8 bg-accent space-y-2 pt-4">
        ...
        <div className="translate-y-12 w-80 h-92 bg-accent pl-8 space-y-2 pt-32">
        ...
        <div className="self-end w-80 h-92 bg-accent pr-8 space-y-2 pt-40">
        ...
        <div className="w-80 h-92 bg-accent pl-8 space-y-2 pt-4">
